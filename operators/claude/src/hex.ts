...
// tool responses (mcp_server.ts) and for the env-var hex values handed to the
// spawned substrate (substrate_client.ts). (v0.9 keyless: the former
// birth-attestation env injection was removed with the anchor surface.)
//
