// v3.1.1.2-descriptive-amendment — full on-chain signing ceremony
// (thin wrapper).
//
...
//
// Runs end-to-end (chained from the v3.1.1.1 ceremony's new_l0_hash):
...
//   4. signL0Revision(prior=v3.1.1.1_new, new=v3.1.1.2, summary).
