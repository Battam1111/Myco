// v3.1.3-autonomy-and-detectors — deterministic hash computation (thin wrapper).
//
...
// runner, the verify test, and `npm run ceremony:v3_1_3:hashes` consume, and
...
//
// This amendment chains FROM the v3.1.2 ceremony's new_l0_hash:
//   cda9e2b3... (v3.1.1.2) → 69456132... (v3.1.2) → <new> (v3.1.3)
//
...
// ---------------------------------------------------------------------------
// CLI entry — `npm run ceremony:v3_1_2:hashes`.
// ---------------------------------------------------------------------------
