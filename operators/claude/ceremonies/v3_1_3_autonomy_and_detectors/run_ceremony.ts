// v3.1.3-autonomy-and-detectors — full on-chain signing ceremony (thin wrapper).
//
...
//
// Runs end-to-end (chained from the v3.1.2 ceremony's new_l0_hash):
...
//   4. signL0Revision(prior=v3.1.2_new, new=v3.1.3, summary).
