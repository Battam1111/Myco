// v3.1.2-witness-corpus — deterministic hash computation (thin wrapper).
//
...
// runner, the verify test, and `npm run ceremony:v3_1_2:hashes` consume, and
...
//
// This amendment chains FROM the v3.1.1.2 ceremony's new_l0_hash:
//   7267dc58... (v3.1.1.1) → cda9e2b3... (v3.1.1.2) → <new> (v3.1.2)
//
