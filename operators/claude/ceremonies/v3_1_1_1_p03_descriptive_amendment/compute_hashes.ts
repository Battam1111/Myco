...
// runner, the verify test, and `npm run ceremony:v3_1_1_1:hashes` consume, and
...
//
// This amendment chains FROM the v3.1.1 ceremony's new_l0_hash:
...
// ---------------------------------------------------------------------------
// CLI entry — `npm run ceremony:v3_1_1_1:hashes`.
// ---------------------------------------------------------------------------
