...
// ---------------------------------------------------------------------------
// **M26.3 P10 Selective Compression** (L0 §10 + L1_SCHEMA §2.5).
//
...
/// **M26.3 P10.b compression invariant set enumeration** (L1_SCHEMA §4.1 tier-1).
///
...
//
// L0 §14 P14.c telos drift semantics (L1_TROPISM §F + algorithms/telos_drift.md):
...
//   - Drift threshold grading per L1_TROPISM §F + algorithms/telos_drift.md.
// ---------------------------------------------------------------------------
...
///
/// PROXY note: doctrine (L1_TROPISM §F + algorithms/telos_drift.md) prescribes
...
/// **M26.4 telos_drift events** (L1_TROPISM §F + algorithms/telos_drift.md).
///
...
// DAG event carrying the raw inputs. Owner-side `anchor_client` re-derives
...
/// on shape mismatch. Used by owner-side reconstruction tooling (`anchor_client`
