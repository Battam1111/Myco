...
//! - L1_SKIN §4.1 — operator handshake + envelope discipline.
//! - L1_HARD_RULES §1 — C2 handshake_pubkey_mismatch (TOFU/match).
//! - L1_HARD_RULES §1 — C2 downgrade protection (pinned-but-absent).
