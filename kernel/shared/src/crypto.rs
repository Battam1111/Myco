...
/// canonical bytes (per L1/SCHEMA §2.1).
///
...
/// HMAC-SHA256 tag.
///
/// Used for envelope_digest in L1/SKIN §2 (keyed by operator_token).
...
mod tests {
    ...
    fn test_ed25519_private_key_debug_redacted() {
        // Per L1/GOVERNANCE §2.1 + L1/HARD_RULES C4-adjacent: never leak the
