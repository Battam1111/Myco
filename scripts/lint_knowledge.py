...
Wave 8).** Prior to Wave 6 this file and src/myco/immune.py were
dual-maintained physical copies of the same 30-dimensional lint
...
`src/myco/immune.py`. This script exists purely to preserve the
