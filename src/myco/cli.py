...
def main():
    ...
    # runs the same 21-dimension substrate immune scan). Both verbs remain
    # primary — neither is deprecated. Design rationale:
    # `docs/primordia/biomimetic_nomenclature_craft_2026-04-12.md §1.3 + §2.3`.
    lint_parser = subparsers.add_parser(
        "lint",
        help="Run 21-dimension substrate immune scan (alias: `myco immune`)",
    )
    ...
    # substrate's 21-dimension immune scan is the immune system of the
    ...
    immune_parser = subparsers.add_parser(
        "immune",
        help="Run 21-dimension substrate immune scan (alias: `myco lint`)",
    )
