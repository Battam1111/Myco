...
**Agent 行为准则**：
- **📜 硬契约** — If docs/agent_protocol.md exists, follow its boot sequence: write surface / tool protocol / boot-end sequence / anti-patterns. L11 write-surface lint + L13 Craft Protocol schema 会自动执行。
