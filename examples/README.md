...
| [`research-assistant/`](research-assistant/) | Solo-researcher knowledge base (papers + decisions + frictions) | full 18-verb surface; propagate out to a derived substrate | ~15 files after use |
...
python -m myco assimilate  # promote raw → integrated
