...
│WORKFLOW  │ docs/current │ _narratives  │ _canon.yaml        │
...
| 辩论/决策记录 | `docs/current/*.md` | ❌ 不可修改 | 完整推理过程——只追加不修改 |
...
| 收尾 | ① 更新任务队列 ② 完整记录 → docs/current/ ③ 结论萃取 → wiki/CLAUDE.md ④ 追加 log.md |
