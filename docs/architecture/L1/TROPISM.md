...
**§E.3 CI classification + scope**: `salience_emergence_rule` (formulas + N, α, W, ε) IS substrate-resident CI per I2 + L1/GOVERNANCE §1.2; mutations require owner attestation. **L1/HARD_RULES F25**. Spore-schema tier-1; child substrates inherit rule + accumulate salience from zero (P8).
