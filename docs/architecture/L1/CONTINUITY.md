...
**§1.3 Cycle-backlog mechanism (C36_cycle_backlog)** — Algorithm: `algorithms/cycle_backlog.md` (predicate + counter + witnesses + escalation to mortality per P11.c). C36 IS signal #7 per L0 §7.3 + L2/OBSERVABILITY §7; feeds §7.4 falsifiability quorum.
...
**i64 nanoseconds** (per L0 §13.1): substrate MUST NOT use i32. Canonical wire + storage = i64 ns since 1970-01-01T00:00:00Z. L1/SCHEMA §4.1 carries through to canonical-bytes serializer (tier-1 SSoT).
