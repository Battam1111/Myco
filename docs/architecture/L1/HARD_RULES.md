...
| C20 | `genesis_attestation_chain_broken` | L1/GOVERNANCE §4.1 + L0 §9.2.1 | Substrate-ID birth attestation does not verify | P1.a | I1 | **L** |
...
| C37 | `doctrine_instability_burst` | L1/GOVERNANCE §6 + L0 §9.4 + L2/OBSERVABILITY §8 | P3 | I2, I4 | **L** |
...
| C40 | `bet_weakening_quorum` | L0 §7.4 + L2/OBSERVABILITY §3 | P14 | I12 | **L** |
| C41 | `dag_cb_integrity_violation` | L1/SCHEMA §2.1 + L0 §9.4 | P1.c, P6, P10 | I4, I9 | **L** |
...
| C44 | `nonce_substrate_minted_replay` | L1/GOVERNANCE §2.2 + L0 §9.2.5 | P1.b'' | I2 | **U** |
| C45 | `substrate_id_low_entropy_collision` | L1/GOVERNANCE §4.1 + L0 §9.2.1 | P1.a | I1 | **U** |
...
Cross-ref L1/GOVERNANCE §1.3 (ALL parameter-tuning CI) + L0 §7.4.e (C40 + P14.c SUSPENDED).
