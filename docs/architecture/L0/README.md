...
- **L1/L2 cross-reference updates** — L1_*.md and L2_*.md still reference "L0 §9.2.5" etc.; need updating to "AS_anchor_surface.md §3.5" form (subsequent housekeeping pass).
