...
## §1. The trust triad (per L0/META §1 + L0/cards/P01_agent_primary.md)
...
**§10.A.4 Deceased without succession** — L1/GOVERNANCE §3.2 + L0/cards/COV06_no_abandonment_succession.md (cultivator mortality): no successor → `legacy` → `orphaned`; terminal-state choice is genesis-Cultivator pre-attestation.

**§10.A.5 Anchor-client tampering** — L0/cards/AS_anchor_surface.md §3.10 + F6: Cultivator signs `anchor_client_provenance_attestation` at genesis declaring install channel structurally independent. Under §11 collapse: not provenance-independent.
