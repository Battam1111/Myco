...
> **Scope**: canonical for Living Bets signals + falsifiability quorum. Cross-cuts L0 §7/§9.4/§14/§15 + L1_HARD_RULES §1 + I3/I5/I9/I10/I12 + L1_SCHEMA §2.4 + L1_CONTINUITY §1.2. All numeric thresholds L1-tunable unless specified.
...
See **L1_HARD_RULES §1**. CRITICAL → auto-quarantine + named immune sporocarp; daily/elevated emit without quarantine. Observatory tracks immune rates in composite #10.
...
Canonical mechanism: **L1_TROPISM §F**. Observatory surfaces `telos_drift` (steady) / `telos_alignment_pending` (birth-period).
