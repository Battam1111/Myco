...
- **Cold-tier sampled drill**: every 1000 substrate-days (L1-tunable [365, 3650]). N = ceil(log₂(cold_count)) random nodes; indices anchor-nonce-derived (per L0 §9.2.5); fruits `cold_tier_sample_recovery_pass`.
