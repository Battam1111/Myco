...
> Reference table extracted from L0/cards/LB_living_bets.md §3 to keep active doctrine lean. Authoritative full enumeration lives at **L2/OBSERVABILITY §2**; this file is a quick-reference mirror.
...
## L0 commitments (carried in L0/cards/LB_living_bets.md §3 + §7.4)
...
- Quorum predicate emission: L0/cards/LB_living_bets.md §3 (falsifiability quorum) + L2/OBSERVABILITY §3 + C40 at L1/HARD_RULES §1.1.
