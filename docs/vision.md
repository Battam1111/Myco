...
**我们的独特定位**："第一个能自我进化的共生认知基质"，Agent+Substrate 共生体自主运转代谢循环（29 维 lint + hunger 自动执行 + 每日 scheduled task），人类只需用自然语言提供方向。
...
- **Substrate 执行选择**：lint 29 维 + hunger signals + compression_pressure + dead_knowledge detection 构成内部免疫系统，过滤无效变异
