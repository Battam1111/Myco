...
| Gear 2: 会话反思 | 会话结束 | "系统哪里可以改进？" → `meta` 条目 |
| Gear 3: 里程碑回顾 | 里程碑后 | 三个 Double-loop 问题 → 修改原则/架构 |
| Gear 4: 跨项目蒸馏 | 项目结束 | 萃取通用模式 → 更新 Myco 模板 |
...
[进行中] W1 即时沉淀 | Gear 1 摩擦记录 | W3 传统手艺（如需）| W4 在线验证
