...
- Write surface discipline: L11 `lint_write_surface` (`src/myco/immune.py`) enforces the whitelist
...
- Self-rewriting rulebook: L0–L17 lint dimensions (18 total), each defined in `src/myco/immune.py` as Python code — itself in the substrate
