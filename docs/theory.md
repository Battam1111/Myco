...
| **L4 进化** | 认知基础设施本身是否在改进？ | ❌ 架构固定 | ✅ Milestone Retrospective/4：架构自进化 + 跨项目蒸馏 |
...
- [wiki/identity.md](../wiki/identity.md) -- Myco 身份定义：Agent-First Symbiotic Cognitive Organism
- [docs/agent_protocol.md](agent_protocol.md) -- Agent 协议：MCP 工具契约与写面规则
- src/myco/lint.py -- 23 维 Lint 免疫系统实现
