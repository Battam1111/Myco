...
（default 5）且无 inlet 历史时触发，建议 `myco absorb` 引导。
...
**Wave 35 status update（2026-04-12）**：scaffold 原语已落地（src/myco/inlet_cmd.py），
...
**Wave 35 status update（2026-04-12）**：partial unblock。Wave 30 落地了 `myco condense`
（forward compression verb），Wave 31 落地了 `myco expand` (reverse)，Wave 33 落地了
`myco prune` (D-layer auto-excretion)。Wave 35 inlet 的 default tag 让 `myco condense
...
- `docs/primordia/` 的 COMPILED/SUPERSEDED 状态机（Craft Protocol）是手工迁移，
  理论上可以 lint 自动建议但未实现。
- Wave 30：`myco condense`（[`docs/primordia/archive/compress_mvp_craft_2026-04-12.md`](primordia/archive/compress_mvp_craft_2026-04-12.md)）forward compression verb。
- Wave 31：`myco expand`（[`docs/primordia/archive/uncompress_mvp_craft_2026-04-12.md`](primordia/archive/uncompress_mvp_craft_2026-04-12.md)）reverse compression。
- Wave 33：`myco prune`（[`docs/primordia/archive/d_layer_prune_craft_2026-04-12.md`](primordia/archive/d_layer_prune_craft_2026-04-12.md)）dead-knowledge auto-excretion。
- Wave 48：`myco colony suggest`（src/myco/cohorts.py）tag-based 压缩建议。
...
依赖链：src/myco/graph.py (Wave 47, v0.36.0) +
...
- src/myco/graph.py 提供 link graph + orphan detection + cluster analysis。
...
- cross-reference graph 已有（`myco mycelium`），但未集成进死知识判定逻辑。

**最小可行种子** — ✅ **已落地于 contract v1.4.0**
（craft 决议：[`docs/primordia/archive/dead_knowledge_seed_craft_2026-04-11.md`](primordia/archive/dead_knowledge_seed_craft_2026-04-11.md)，
kernel_contract 级，置信度 0.91，L13 强制）：
- `myco observe <id>` 在单 note 模式下通过 `record_view()` 写入 frontmatter 的
...
- Wave 33 (v0.29.0)：`myco prune` verb 落地（[`docs/primordia/archive/d_layer_prune_craft_2026-04-12.md`](primordia/archive/d_layer_prune_craft_2026-04-12.md)），
...
cross-reference 图（已有 `myco mycelium`）、自适应阈值（随 substrate 年龄进化）。
...
brief——都依赖 agent 主动调用 `myco hunger` 或 `myco immune` 作为心跳。
...
**已尝试的缓解**（仍不是解决）：
- Wave 12: L15 craft reflex（[`docs/primordia/craft_reflex_craft_2026-04-11.md`](primordia/craft_reflex_craft_2026-04-11.md)）—— 依赖 `myco immune` 被运行。
- Wave 13: boot reflex arc（[`docs/primordia/archive/boot_reflex_arc_craft_2026-04-11.md`](primordia/archive/boot_reflex_arc_craft_2026-04-11.md)）—— 依赖 `myco_pulse` 被 MCP tool 调用。
- Wave 17: boot brief injector（[`docs/primordia/archive/boot_brief_injector_craft_2026-04-11.md`](primordia/archive/boot_brief_injector_craft_2026-04-11.md)）—— 把信号写进 MYCO.md 热区，把 "agent
  ...
  本身不在 L6 扫描范围内）。
- Wave 18: opt-in git pre-commit hook（[`docs/primordia/archive/l15_surface_and_git_hooks_craft_2026-04-11.md`](primordia/archive/l15_surface_and_git_hooks_craft_2026-04-11.md)）—— 覆盖了写路径的一部分，但
...
3. **MCP server 能部分接管**：如果宿主加载了 `myco.mcp_server`，那么
   `myco_pulse` tool 可以在每次 agent tool-call 时做一次 low-cost
...
`myco_trace` MCP tool（[`src/myco/mcp_server.py`](../src/myco/mcp_server.py)）**或** shell `>>` / HEREDOC 追加。两个路径的
...
**潜在缓解**（非阻塞，仅记录）：
- 如果未来 MCP server 启用率 > 80%，可以考虑在 MCP `myco_trace`
...
- [docs/primordia/archive/inlet_mvp_craft_2026-04-12.md](primordia/archive/inlet_mvp_craft_2026-04-12.md) -- Inlet scaffold 原语
- [docs/primordia/archive/metabolic_inlet_design_craft_2026-04-12.md](primordia/archive/metabolic_inlet_design_craft_2026-04-12.md) -- Inlet 设计决策
- [docs/primordia/archive/proactive_discovery_craft_2026-04-12.md](primordia/archive/proactive_discovery_craft_2026-04-12.md) -- 主动发现：inlet_ripe 信号
- [docs/primordia/archive/compress_mvp_craft_2026-04-12.md](primordia/archive/compress_mvp_craft_2026-04-12.md) -- 压缩 MVP
- [docs/primordia/archive/uncompress_mvp_craft_2026-04-12.md](primordia/archive/uncompress_mvp_craft_2026-04-12.md) -- 反向压缩
- [docs/primordia/archive/d_layer_prune_craft_2026-04-12.md](primordia/archive/d_layer_prune_craft_2026-04-12.md) -- D 层 auto-excretion
...
- src/myco/graph.py -- Link Graph 实现（orphan delta metric）

**Problem 6 (Self Model D)**:
- [docs/primordia/archive/dead_knowledge_seed_craft_2026-04-11.md](primordia/archive/dead_knowledge_seed_craft_2026-04-11.md) -- 死知识种子
- [docs/primordia/archive/d_layer_prune_craft_2026-04-12.md](primordia/archive/d_layer_prune_craft_2026-04-12.md) -- Prune verb
...
- [docs/primordia/archive/boot_reflex_arc_craft_2026-04-11.md](primordia/archive/boot_reflex_arc_craft_2026-04-11.md) -- Boot 反射弧
- [docs/primordia/archive/boot_brief_injector_craft_2026-04-11.md](primordia/archive/boot_brief_injector_craft_2026-04-11.md) -- Boot Brief 注入器
- [docs/primordia/archive/l15_surface_and_git_hooks_craft_2026-04-11.md](primordia/archive/l15_surface_and_git_hooks_craft_2026-04-11.md) -- Git hooks

**Problem 8 (Dual Append Paths)**:
- [src/myco/mcp_server.py](../src/myco/mcp_server.py) -- MCP Server（myco_trace tool）
