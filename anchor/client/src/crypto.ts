// Cryptographic primitives — TypeScript implementation (L1/SCHEMA §2.1 + L1/SKIN §2).
//
...
/** HMAC keyed by empty key (forbidden per L1/SKIN §2). */
 ...
 * encodings (per L1/SCHEMA §2.1 + pass-3 mycoparasite-2 + L1/HARD_RULES C6/C7).
 */
...
//
// Selected for M2 per L1/GOVERNANCE §7 candidate set {Ed25519, ECDSA-P256,
