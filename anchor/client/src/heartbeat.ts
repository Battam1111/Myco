// Owner liveness heartbeat — TypeScript implementation (L1/GOVERNANCE §3.2).
//
// Per L1/GOVERNANCE §3.2 owner succession: succession activation uses
...
//
// Per L1/HARD_RULES §4: owner_liveness_heartbeat is anchor-surface-resident
...
//
// Cadence (L1/GOVERNANCE §7 default: monthly) is owner-policy; this module
 ...
 *
 * Per L1/GOVERNANCE §3.2: the heartbeat is owner-attested. Substrate
 ...
 *
 * Used by the succession-trigger logic per L1/GOVERNANCE §3.2: when
