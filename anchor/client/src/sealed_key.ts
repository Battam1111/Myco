// Sealed-key access — TypeScript implementation (L1/GOVERNANCE §2.1).
//
// Per L1/GOVERNANCE §2.1: the owner's signing key MUST live outside the
...
// anchor-client deployments MUST replace this with one of the L1/GOVERNANCE
 ...
 * memory; any process with access to the anchor-client memory can read it.
 *
 * Production anchor-client deployments MUST replace with one of:
 *
