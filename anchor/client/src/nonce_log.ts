// Anchor-surface nonce log — TypeScript implementation (L1/GOVERNANCE §2.2 + §2.3).
//
// Per L1/GOVERNANCE §2.2 step 1: the anchor surface (NOT the substrate) issues
...
//
// Per L1/GOVERNANCE §2.3 step 4: the anchor surface maintains the
...
/** Default nonce TTL (5 minutes per L1/GOVERNANCE §2.2 default). */
...
/** Rate-limit hit (per L1/GOVERNANCE §2.2: triggers
 ...
 *
 * Per L1/HARD_RULES §4 (anchor-surface-resident state): the substrate cannot
...
export class NonceLog {
   ...
   *
   * Per L1/GOVERNANCE §2.2 step 1: the anchor surface binds the nonce to
