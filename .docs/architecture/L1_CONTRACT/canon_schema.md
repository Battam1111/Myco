...
schema_version: "2"                # v0.6.0 — bumps on structural schema change
contract_version: "v0.6.15"        # must match L1 protocol.md
synced_contract_version: "v0.6.15" # updated by `myco assimilate`
