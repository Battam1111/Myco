# Contract Changelog — pre-v0.8.0 archive

> **Status**: immutable history.
> **Scope**: v0.7.10 (2026-05-10) ← v0.6.10 (2026-04-28).
> **Parent file**: [`../../contract_changelog.md`](../../contract_changelog.md)
> covers v0.8.0 onwards.
>
> Archived at v0.8.6 (2026-05-12) as part of the 永恒删减 sweep.
> The main changelog had grown to 1739 lines, with 58% of the content
> describing releases more than a minor cycle old. Per L0 P3
> (永恒进化), append-only history is preserved — file-tree placement
> is just a navigation aid. Git history retains the pre-split state.
