...
> 最后更新：2026-04-11
> **知识系统**：[Myco](https://github.com/Battam1111/Myco) v1.1.0（框架自用，kernel contract v1.5.0）
...
**当前阶段**：v1.1.0 released — public launch 准备中；v1.2 消化道 Phase ② 进行中（Upstream Protocol v1.0 + Craft Protocol v1 + Self-Model D 层种子 + 仿生结构 overlay 已落地，kernel contract v1.5.0）
