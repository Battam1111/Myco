...
> 🫀 **Boot signals** (last `myco hunger`: `2026-04-12T14:55:05Z`)
>
...
| 指标 | 值 | rationale | 证据锚 |
|------|----|-----------|--------|
| `v1_launch_progress` | 0.65 | PyPI v0.2.0 已发布；kernel contract v0.45.0；23 lint + Agent Review + 19 MCP tools + 122 tests；dist/ 1.1.0 wheel 已清理。剩余：README v1 里程碑对齐、Show HN launch | PyPI 0.2.0 live, Metamorphosis plan |
...
| `notes_digestion_pressure` | 0.02 | 132 notes，1 raw / 2 digesting / 62 extracted / 67 integrated / 0 excreted。pressure = (1+2)/max(1,62+67) = 0.023。hunger reports healthy | myco hunger 2026-04-12, 132 notes |
